<section style="background-image: url(/imagens/site/banner-desktop.png)" class="bg-fixed overflow-hidden pb-10 pt-40 lg:pt-48 xxl:pt-40 flex justify-center items-center bg-center bg-cover h-[80vh] lg:h-screen xxl:h-[75vh]">
